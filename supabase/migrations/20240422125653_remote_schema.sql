...
CREATE POLICY "ALL authenticated users All operations" ON "public"."orders" USING (true);

CREATE POLICY "ALL users All operations" ON "public"."order_items" USING (true);

CREATE POLICY "Allow authenticated users ALL operations" ON "public"."products" TO "authenticated" USING (true);
